...
import { ChevronDown, Calculator, HelpCircle, ArrowRight } from "lucide-react";
      ...
      <AnimatePresence mode="wait">
        {showMacroCalculator ? (
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <Card className="w-full backdrop-blur-sm bg-gradient-to-r from-primary/10 to-secondary/10 border-0 shadow-xl rounded-2xl p-6">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Meal planning is more than just deciding what to eat. It's about making conscious choices that align with your health goals and lifestyle.
                </p>
                <p>
                  By planning your meals in advance, you can:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <li>Save time and reduce stress around meal decisions</li>
                  <li>Maintain a balanced and nutritious diet</li>
                  <li>Reduce food waste and save money</li>
                  <li>Stay on track with your health goals</li>
                </ul>
              </div>
            </Card>

            <Card className="w-full backdrop-blur-sm bg-gradient-to-r from-accent to-secondary/10 border-0 shadow-xl rounded-2xl p-6">
              <h2 className="text-2xl font-semibold mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                Understanding Macros
              </h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Macronutrients (macros) are the building blocks of your diet:
                </p>
                <div className="grid gap-4">
                  <div className="p-4 rounded-lg bg-white/50">
                    <h3 className="font-semibold mb-2">Proteins (4 calories/gram)</h3>
                    <p className="text-sm">Essential for muscle repair and growth</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/50">
                    <h3 className="font-semibold mb-2">Carbohydrates (4 calories/gram)</h3>
                    <p className="text-sm">Your body's primary energy source</p>
                  </div>
                  <div className="p-4 rounded-lg bg-white/50">
                    <h3 className="font-semibold mb-2">Fats (9 calories/gram)</h3>
                    <p className="text-sm">Important for hormone production and nutrient absorption</p>
                  </div>
                </div>
              </div>
            </Card>
