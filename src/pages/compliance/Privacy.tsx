  ...
  return (
    <BaseLayout>
      <SEO 
        ...
        description="Read about SousChef's privacy policy, data collection practices, and how we protect your personal information while using our AI-powered meal planning platform."
